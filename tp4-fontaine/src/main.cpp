...
void chargerNuanceurs()
{
    ...
    std::cout << "Charger le nuanceur de ce TP" << std::endl;
    {
        ...
        // attacher le nuanceur de sommets
        // const GLchar *chainesSommets = ProgNuanceur::lireNuanceur( "nuanceurSommPoints.glsl" );
        ...
        // const GLchar *chainesGeometrie = ProgNuanceur::lireNuanceur( "nuanceurGeomPoints.glsl" );
...
void afficherModele()
{
    ...
    switch ( Etat::texnumero ) // 0-aucune, 1-étincelle, 2-oiseau
    {
...
void FenetreTP::clavier( TP_touche touche )
{
    ...
    case TP_t: // Changer la texture utilisée: 0-aucune, 1-étincelle, 2-oiseau
